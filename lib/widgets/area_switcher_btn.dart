...
class AreaSwitcherBtn extends StatelessWidget {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Text(isCurrentlyConsumer ? '🏪' : '⚡', style: TextStyle(fontSize: showText ? 14 : 11)),
            if (showText) ...[
  ...
  void _showMerchantAccountSwitcher(BuildContext context, WalletService wallet) {
  ...
  void _showConsumerAccountSwitcher(BuildContext context, WalletService wallet) {
