...
//
// PATCH IRIS: era 20. Uma carteira restaurada em outro aparelho precisa REDESCOBRIR quais
// indices foram usados, e 20 nao alcanca fundos deixados em indices altos por versoes antigas
// do app (medido: um UTXO real no indice externo 112, invisivel com gap 20). Este valor so
// pesa na varredura completa, que roda uma vez por pasta de no.
pub(crate) const BDK_CLIENT_STOP_GAP: usize = 150;
...
// PATCH IRIS: a varredura completa consulta centenas de enderecos e nao cabe nos 20s do sync
// incremental. Timeout proprio para ela; o incremental segue rapido.
pub(crate) const BDK_WALLET_FULL_SCAN_TIMEOUT_SECS: u64 = 180;
