...
/// Conferência da semente: sorteia posições e monta alternativas para o
/// usuário provar que anotou as palavras.
///
/// Vive aqui, e não dentro das telas, porque a área pessoal e a do lojista
/// fazem a mesma conferência — duplicada, uma correção valia só para um lado.
class SeedQuiz {
  /// Posições sorteadas (base 0), em ordem crescente.
  final List<int> indices;

  /// Alternativas de cada pergunta, já embaralhadas.
  final List<List<String>> alternativas;

  const SeedQuiz({required this.indices, required this.alternativas});

  /// Quantas palavras são conferidas, independentemente de a semente ter 12
  /// ou 24. Com 4 posições e 3 alternativas cada, acertar por sorte é 1 em 81.
  ...
  /// A correta, mais uma palavra da própria semente e uma de fora — assim o
  /// usuário não acerta só por reconhecer "uma palavra que estava lá".
  ...
  /// Amostra da lista BIP39 usada só como distrator visual.
