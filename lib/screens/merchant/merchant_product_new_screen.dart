...
class MerchantProductNewScreen extends StatefulWidget {
  const MerchantProductNewScreen({super.key});

  @override
  State<MerchantProductNewScreen> createState() => _MerchantProductNewScreenState();
}

class _MerchantProductNewScreenState extends State<MerchantProductNewScreen> {
  final TextEditingController _nameCtrl = TextEditingController();
  final TextEditingController _brlCtrl = TextEditingController();
  final TextEditingController _satsCtrl = TextEditingController();
  ...
  void _saveProduct() {
    ...
    context.read<WalletService>().addMerchantProduct(p);
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text('Novo produto', style: Theme.of(context).textTheme.bodyLarge?.copyWith(fontWeight: FontWeight.w700)),
                      ],
                    ),
                  ),
                  IconButton(
