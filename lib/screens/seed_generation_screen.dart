                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(wallet.consumerAccounts.isNotEmpty ? 'Anote a semente da sua nova carteira. Você precisará dela para backup.' : 'Anote em um lugar seguro. É a sua única forma de recuperar a conta.', style: Theme.of(context).textTheme.bodySmall?.copyWith(color: BitpayTheme.textSecondary)),
                          ],
                        ),
                      ),
                    ],
